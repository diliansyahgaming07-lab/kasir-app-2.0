...
<body class="flex items-center justify-center min-h-screen">
    <div class="bg-gray-900 rounded-2xl p-8 w-full max-w-md">
        <div class="text-center mb-6">
            ...
            <p class="text-gray-400 mt-2">Login sebagai customer</p>
        </div>
        ...
        <form method="POST" action="/login-customer">
            ...
            <button type="submit" class="btn-primary w-full py-3 rounded-lg font-bold transition">Login</button>
        </form>
        
        <div class="text-center mt-4">
            <a href="/register-customer" class="text-cyan-400 hover:underline">Belum punya akun? Register</a>
        </div>
    </div>
</body>
</html>