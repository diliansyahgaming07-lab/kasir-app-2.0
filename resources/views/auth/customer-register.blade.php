    ...
    <div class="bg-gray-900 rounded-2xl p-8 w-full max-w-md">
        ...
        <form method="POST" action="/register-customer">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="phone" required class="w-full px-4 py-2 bg-gray-800 border border-gray-700 rounded-lg" placeholder="08123456789">
            </div>
            <div class="mb-4">
                <label class="block text-sm mb-2">Alamat</label>
                <textarea name="address" required rows="2" class="w-full px-4 py-2 bg-gray-800 border border-gray-700 rounded-lg" placeholder="Jl. Contoh No. 123, Jakarta"></textarea>
            </div>
            <div class="mb-4">
